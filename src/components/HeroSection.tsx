...
export function HeroSection() {
  ...
  // Parallax layers — slower = deeper, faster = closer
  ...
  // Floating block parallax — different depths
  ...
  return (
    ...
    >
      ...
      {/* MID LAYER — speed lines + dots traveling at different speeds */}
      <motion.div
        aria-hidden
        style={{ y: yLines }}
      ...
      >
        ...
        <motion.div
          ...
          className="mt-7 sm:mt-9 flex flex-col sm:flex-row flex-wrap gap-3 justify-center w-full max-w-xl"
        >
          <a
            href="#contacto"
        ...
        {/* LAPTOP STAGE — transparent png + parallax blocks around it */}
        <div className="relative w-full mt-10 sm:mt-14 max-w-4xl">
          ...
          {/* Floating parallax blocks — TOP LEFT */}
          <motion.div
            style={{ y: yBlockTL }}
          ...
          {/* Laptop — transparent + parallax + idle float */}
          <motion.div
